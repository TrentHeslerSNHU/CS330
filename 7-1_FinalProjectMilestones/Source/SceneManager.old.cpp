...
void SceneManager::DrawCoffee() {
	...
	glm::vec3 positionXYZ;
	float itemScale = 1.0;
	glm::vec3 itemOrigin = { 0.0f, 0.16f, 0.0f };

	// -- MUG BASE --
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3((itemScale * 1.0f), (itemScale * 1.25f), (itemScale * 1.0f));
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3((itemOrigin[0] + 0.0f), (itemOrigin[1] - 0.15f), (itemOrigin[2] + 0.0f));
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3((itemScale * 0.9f), (itemScale * 0.1f), (itemScale * 0.9f));
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3((itemOrigin[0] + 0.0f), (itemOrigin[1] + 1.05f), (itemOrigin[2] + 0.0f));
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3((itemScale * 0.9f), (itemScale * 0.9f), (itemScale * 0.9f));
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3((itemOrigin[0] + 0.0f), (itemOrigin[1] + 1.1f), (itemOrigin[2] + 0.0f));
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3((itemOrigin[0] + -1.25f), (itemOrigin[1] + 0.5f), (itemOrigin[2] + 0.0f));
